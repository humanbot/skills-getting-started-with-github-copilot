              ...
              <ul class="participants-list" style="list-style: none; padding-left: 0;">
                ${details.participants.map(email => `
                  <li style="display: flex; align-items: center; margin-bottom: 2px;">
                    <span>${email}</span>
                    <span class="delete-participant" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(email)}" title="Remove participant" style="cursor:pointer; color: #d00; margin-left: 8px; font-weight: bold;">&times;</span>
                  </li>
                `).join("")}
              </ul>
            </div>
